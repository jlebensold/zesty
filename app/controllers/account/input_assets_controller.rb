...
class Account::InputAssetsController < ApplicationController
  ...
  def create
    ...
    redirect_to account_classifier_input_assets_path(@classifier), notice: 'Record(s) has been created.'
  end
  ...
  def destroy
    ...
    @input_asset.destroy!
    redirect_to account_classifier_input_assets_path(@classifier), notice: 'Record(s) has been destroyed.'
  end
